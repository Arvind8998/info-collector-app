...
function getCountryOfWork() {
  ...
  function getHolidayAllowance() {
    return screen.getByRole("textbox", { name: /Holiday Allowance/i });
  }

  function getMaritalStatus() {
    return screen.getByRole("textbox", { name: /Marital Status/i });
  }

  function getNumberOfChildren() {
    return screen.getByRole("textbox", { name: /Number of Children/i });
  }
...
function selectJobSituation(jobSituation) {
